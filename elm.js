...
{
	if (region.dj.aa === region.a7.aa)
	{
		return 'on line ' + region.dj.aa;
	}
	return 'on lines ' + region.dj.aa + ' through ' + region.a7.aa;
}
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { cF: 'hidden', X: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { cF: 'mozHidden', X: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { cF: 'msHidden', X: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { cF: 'webkitHidden', X: 'webkitvisibilitychange' }
		: { cF: 'hidden', X: 'visibilitychange' };
}
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {bb: fragment, bh: host, by: path, bA: port_, bE: protocol, bF: query};
	});
...
var $author$project$Main$TableAndParserView = 0;
...
var $elm$parser$Parser$Advanced$DeadEnd = F4(
	function (row, col, problem, contextStack) {
		return {a5: col, cs: contextStack, bB: problem, bI: row};
	});
...
var $elm$parser$Parser$Advanced$fromState = F2(
	function (s, x) {
		return A2(
			...
			A4($elm$parser$Parser$Advanced$DeadEnd, s.bI, s.a5, x, s.c));
	});
		...
		while (true) {
			...
			if (_Utils_eq(newOffset, -1)) {
				return A3(
					...
					0,
					{a5: col, c: s0.c, d: s0.d, b: offset, bI: row, a: s0.a});
			} else {
...
var $elm$parser$Parser$Advanced$chompWhile = function (isGood) {
	return function (s) {
		return A5($elm$parser$Parser$Advanced$chompWhileHelp, isGood, s.b, s.bI, s.a5, s);
	};
};
...
var $elm$parser$Parser$Advanced$keyword = function (_v0) {
	...
	return function (s) {
		var _v1 = A5($elm$parser$Parser$Advanced$isSubString, kwd, s.b, s.bI, s.a5, s.a);
		var newOffset = _v1.a;
		var newRow = _v1.b;
		var newCol = _v1.c;
		return (_Utils_eq(newOffset, -1) || (0 <= A3(
			...
			progress,
			0,
			{a5: newCol, c: s.c, d: s.d, b: newOffset, bI: newRow, a: s.a});
	};
};
	...
	function (isGood, expecting) {
		return function (s) {
			...
			return _Utils_eq(newOffset, -1) ? A2(
				...
				true,
				0,
				{a5: 1, c: s.c, d: s.d, b: s.b + 1, bI: s.bI + 1, a: s.a}) : A3(
				$elm$parser$Parser$Advanced$Good,
				true,
				0,
				{a5: s.a5 + 1, c: s.c, d: s.d, b: newOffset, bI: s.bI, a: s.a}));
		};
	});
...
var $elm$parser$Parser$Advanced$token = function (_v0) {
	...
	return function (s) {
		var _v1 = A5($elm$parser$Parser$Advanced$isSubString, str, s.b, s.bI, s.a5, s.a);
		var newOffset = _v1.a;
		var newRow = _v1.b;
		var newCol = _v1.c;
		return _Utils_eq(newOffset, -1) ? A2(
...
var $elm$parser$Parser$Advanced$varHelp = F7(
	function (isGood, offset, row, col, src, indent, context) {
		...
		while (true) {
			...
			if (_Utils_eq(newOffset, -1)) {
				return {a5: col, c: context, d: indent, b: offset, bI: row, a: src};
			} else {
				if (_Utils_eq(newOffset, -2)) {
					var $temp$isGood = isGood,
						$temp$offset = offset + 1,
...
var $elm$parser$Parser$Advanced$variable = function (i) {
	return function (s) {
		var firstOffset = A3($elm$parser$Parser$Advanced$isSubChar, i.dj, s.b, s.a);
		if (_Utils_eq(firstOffset, -1)) {
			return A2(
				$elm$parser$Parser$Advanced$Bad,
				false,
				A2($elm$parser$Parser$Advanced$fromState, s, i.a9));
		} else {
			var s1 = _Utils_eq(firstOffset, -2) ? A7($elm$parser$Parser$Advanced$varHelp, i.cM, s.b + 1, s.bI + 1, 1, s.a, s.d, s.c) : A7($elm$parser$Parser$Advanced$varHelp, i.cM, firstOffset, s.bI, s.a5 + 1, s.a, s.d, s.c);
			var name = A3($elm$core$String$slice, s.b, s1.b, s.a);
			return A2($elm$core$Set$member, name, i.c5) ? A2(
				$elm$parser$Parser$Advanced$Bad,
				false,
				A2($elm$parser$Parser$Advanced$fromState, s, i.a9)) : A3($elm$parser$Parser$Advanced$Good, true, name, s1);
		}
	};
};
var $elm$parser$Parser$variable = function (i) {
	return $elm$parser$Parser$Advanced$variable(
		{a9: $elm$parser$Parser$ExpectingVariable, cM: i.cM, c5: i.c5, dj: i.dj});
};
			...
			switch (atomData.$) {
				case 0:
					return $elm$parser$Parser$Loop(
						A2($elm$core$List$cons, atomData, atomsSoFar));
				case 1:
					return $elm$parser$Parser$Loop(
						A2($elm$core$List$cons, atomData, atomsSoFar));
				case 2:
				...
				default:
					...
					return (str === '') ? $elm$parser$Parser$Done(
						$elm$core$List$reverse(atomsSoFar)) : $elm$parser$Parser$Done(
						$elm$core$List$reverse(atomsSoFar));
			}
		});
	return A2(
				...
				A2(
					...
					A2(
						...
						$elm$parser$Parser$variable(
							{
								cM: $elm$core$Char$isLower,
								c5: $elm$core$Set$fromList(_List_Nil),
								dj: $elm$core$Char$isUpper
							})),
					$elm$parser$Parser$oneOf(
						_List_fromArray(
							[
...
var $elm$parser$Parser$DeadEnd = F3(
	function (row, col, problem) {
		return {a5: col, bB: problem, bI: row};
	});
											...
											return function (discoveredBy) {
												return function (namedBy) {
													return function (phaseChanges) {
														return {cx: discoveredBy, cy: electronShells, bs: name, cT: namedBy, c2: phaseChanges, c4: protons, bK: section, dk: state, dq: summary, dr: symbol, dO: weight, dP: wikiLink, bX: xpos, dR: ypos};
													};
												};
											};
										};
...
var $author$project$Data$Atom$Actinide = 10;
var $author$project$Data$Atom$Alkali = 1;
var $author$project$Data$Atom$AlkalineEarth = 2;
var $author$project$Data$Atom$Halogen = 7;
var $author$project$Data$Atom$Hydrogen = 0;
var $author$project$Data$Atom$Lanthanide = 9;
var $author$project$Data$Atom$Metalloid = 5;
var $author$project$Data$Atom$NobleGas = 8;
var $author$project$Data$Atom$NonMetal = 6;
var $author$project$Data$Atom$PostTransitionMetal = 4;
var $author$project$Data$Atom$TransitionMetal = 3;
var $author$project$Data$Atom$UnknownSection = 11;
var $author$project$DataBase$DataParser$sectionDecoder = A2(
	...
	$elm$json$Json$Decode$string);
var $author$project$Data$Atom$Gas = 2;
var $author$project$Data$Atom$Liquid = 1;
var $author$project$Data$Atom$Solid = 0;
var $author$project$Data$Atom$UnknownState = 3;
...
var $author$project$DataBase$DataParser$retrieveAtom = function (symbol) {
	var filteredAtomList = A2(
		...
		function (atom) {
			return _Utils_eq(atom.dr, symbol);
		},
...
var $elm$parser$Parser$problemToDeadEnd = function (p) {
	return A3($elm$parser$Parser$DeadEnd, p.bI, p.a5, p.bB);
};
...
var $elm$parser$Parser$Advanced$run = F2(
	function (_v0, src) {
		var parse = _v0;
		var _v1 = parse(
			{a5: 1, c: _List_Nil, d: 1, b: 0, bI: 1, a: src});
		if (!_v1.$) {
			var value = _v1.b;
			return $elm$core$Result$Ok(value);
		} else {
...
var $author$project$Main$moleculeDataInit = {
	_: $author$project$Data$Molecule$fromString('CuSO4 5H2O'),
	ar: 'CuSO4 5H2O',
	aw: _List_Nil
};
var $author$project$Main$initModel = function (flags) {
	return {Z: 0, y: $author$project$Main$moleculeDataInit, ab: $elm$core$Maybe$Nothing, aU: flags};
};
...
var $author$project$Main$ZoomAtomView = 1;
					...
					_Utils_update(
						model,
						{
							y: _Utils_update(
								c,
								{
									_: $author$project$Data$Molecule$fromString(text),
									ar: text,
									aw: $author$project$Data$Molecule$toAtomList(
...
var $author$project$Main$UnZoomAtom = {$: 2};
...
var $mdgriffith$elm_ui$Internal$Style$classes = {bZ: 'a', aA: 'atv', b$: 'ab', b0: 'cx', b1: 'cy', b2: 'acb', b3: 'accx', b4: 'accy', b5: 'acr', aZ: 'al', a_: 'ar', b6: 'at', aB: 'ah', aC: 'av', b8: 's', cc: 'bh', cd: 'b', cf: 'w7', ch: 'bd', ci: 'bdt', ai: 'bn', cj: 'bs', aj: 'cpe', co: 'cp', cp: 'cpx', cq: 'cpy', v: 'c', al: 'ctr', am: 'cb', an: 'ccx', w: 'ccy', Y: 'cl', ao: 'cr', cr: 'ct', ct: 'cptr', cu: 'ctxt', cC: 'fcs', cD: 'fs', cE: 'g', aH: 'hbh', aq: 'hc', aI: 'hf', bf: 'hfp', cG: 'hv', cI: 'ic', cK: 'fr', cN: 'iml', cO: 'it', cQ: 'i', Q: 'nb', bt: 'notxt', cV: 'ol', cX: 'or', J: 'oq', c0: 'oh', bw: 'pg', bx: 'p', c1: 'ppe', c7: 'ui', bI: 'r', c9: 'sb', da: 'sbx', db: 'sby', dc: 'sbt', de: 'e', df: 'cap', dg: 'sev', dn: 'sk', ds: 't', dt: 'tc', du: 'w8', dv: 'w2', dw: 'w9', dx: 'tj', ax: 'tja', dy: 'tl', dz: 'w3', dA: 'w5', dB: 'w4', dC: 'tr', dD: 'w6', dE: 'w1', dF: 'tun', bR: 'ts', L: 'clr', dK: 'u', aV: 'wc', bV: 'we', aW: 'wf', bW: 'wfp', aX: 'wrp'};
...
var $mdgriffith$elm_ui$Internal$Model$columnClass = $mdgriffith$elm_ui$Internal$Style$classes.b8 + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.v);
var $mdgriffith$elm_ui$Internal$Model$gridClass = $mdgriffith$elm_ui$Internal$Style$classes.b8 + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.cE);
var $mdgriffith$elm_ui$Internal$Model$pageClass = $mdgriffith$elm_ui$Internal$Style$classes.b8 + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.bw);
var $mdgriffith$elm_ui$Internal$Model$paragraphClass = $mdgriffith$elm_ui$Internal$Style$classes.b8 + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.bx);
var $mdgriffith$elm_ui$Internal$Model$rowClass = $mdgriffith$elm_ui$Internal$Style$classes.b8 + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.bI);
var $mdgriffith$elm_ui$Internal$Model$singleClass = $mdgriffith$elm_ui$Internal$Style$classes.b8 + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.de);
	...
	switch (style.$) {
		...
		case 8:
			...
			return 'grid-rows-' + (A2(
				...
				$elm$core$String$join,
				'-',
				A2($elm$core$List$map, $mdgriffith$elm_ui$Internal$Model$lengthClassName, template.p)) + ('-space-x-' + ($mdgriffith$elm_ui$Internal$Model$lengthClassName(template.dh.a) + ('-space-y-' + $mdgriffith$elm_ui$Internal$Model$lengthClassName(template.dh.b)))))));
		case 9:
			var pos = style.a;
			return 'gp grid-pos-' + ($elm$core$String$fromInt(pos.bI) + ('-' + ($elm$core$String$fromInt(pos.a5) + ('-' + ($elm$core$String$fromInt(pos.bU) + ('-' + $elm$core$String$fromInt(pos.bd)))))));
		case 11:
		...
		_List_fromArray(
			[
				...
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.cG, $mdgriffith$elm_ui$Internal$Style$classes.L)) + ':hover',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '0')
					])),
				...
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.cG, $mdgriffith$elm_ui$Internal$Style$classes.J)) + ':hover',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '1')
					])),
				...
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.cC, $mdgriffith$elm_ui$Internal$Style$classes.L)) + ':focus',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '0')
					])),
				...
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.cC, $mdgriffith$elm_ui$Internal$Style$classes.J)) + ':focus',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '1')
					])),
				...
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.aA, $mdgriffith$elm_ui$Internal$Style$classes.L)) + ':active',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '0')
					])),
				...
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.aA, $mdgriffith$elm_ui$Internal$Style$classes.J)) + ':active',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '1')
					])),
...
var $mdgriffith$elm_ui$Internal$Style$overrides = '@media screen and (-ms-high-contrast: active), (-ms-high-contrast: none) {' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.b8) + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.bI) + (' > ' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.b8) + (' { flex-basis: auto !important; } ' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.b8) + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.bI) + (' > ' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.b8) + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.al) + (' { flex-basis: auto !important; }}' + ($mdgriffith$elm_ui$Internal$Style$sliderOverrides + $mdgriffith$elm_ui$Internal$Style$explainer))))))))))));
...
var $mdgriffith$elm_ui$Internal$Style$emptyIntermediate = F2(
	function (selector, closing) {
		return {ak: closing, h: _List_Nil, A: _List_Nil, s: selector};
	});
					...
					case 2:
						...
						return _Utils_update(
							rendered,
							{
								h: A2(
									$elm$core$List$cons,
									{ak: '\n}', h: _List_Nil, A: props, s: '@supports (' + (prop + (':' + (value + (') {' + parent.s))))},
									rendered.h)
							});
					case 4:
						var selector = rule.a;
...
var $mdgriffith$elm_ui$Internal$Style$renderCompact = function (styleClasses) {
	...
	var renderClass = function (rule) {
		...
		if (!_v2.b) {
			...
			return rule.s + ('{' + (renderValues(rule.A) + (rule.ak + '}')));
		}
	};
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					A2(
					$mdgriffith$elm_ui$Internal$Model$bracket,
					'.' + (name + ('.' + ($mdgriffith$elm_ui$Internal$Style$classes.df + ('> .' + ($mdgriffith$elm_ui$Internal$Style$classes.ds + (', .' + (name + (' .' + ($mdgriffith$elm_ui$Internal$Style$classes.df + (' > .' + $mdgriffith$elm_ui$Internal$Style$classes.ds)))))))))),
					_List_fromArray(
						[
...
var $mdgriffith$elm_ui$Internal$Model$adjust = F3(
	function (size, height, vertical) {
		return {bd: height / size, T: size, bT: vertical};
	});
...
var $mdgriffith$elm_ui$Internal$Model$convertAdjustment = function (adjustment) {
	var lines = _List_fromArray(
		[adjustment.cm, adjustment.cb, adjustment.cv, adjustment.cR]);
	var lineHeight = 1.5;
	...
	return _Utils_Tuple2(
		...
		_List_fromArray(
			[
				...
				_Utils_Tuple2(
				'font-size',
				$elm$core$String$fromFloat(converted.T) + 'em')
			]));
};
			...
			function (rule, maybePseudo) {
				switch (rule.$) {
					...
					case 5:
						...
						var row = '.' + $mdgriffith$elm_ui$Internal$Style$classes.bI;
					...
					case 9:
						...
						var msPosition = A2(
							...
							_List_fromArray(
								[
									'-ms-grid-row: ' + ($elm$core$String$fromInt(position.bI) + ';'),
						...
						var modernPosition = A2(
							...
							_List_fromArray(
								[
									'grid-row: ' + ($elm$core$String$fromInt(position.bI) + (' / ' + ($elm$core$String$fromInt(position.bI + position.bd) + ';'))),
									'grid-column: ' + ($elm$core$String$fromInt(position.a5) + (' / ' + ($elm$core$String$fromInt(position.a5 + position.bU) + ';')))
								]));
						var _class = '.grid-pos-' + ($elm$core$String$fromInt(position.bI) + ('-' + ($elm$core$String$fromInt(position.a5) + ('-' + ($elm$core$String$fromInt(position.bU) + ('-' + $elm$core$String$fromInt(position.bd)))))));
					...
					return A3(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class($mdgriffith$elm_ui$Internal$Style$classes.b8 + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.de))
									]))
							]));
			}
		}();
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.b8, $mdgriffith$elm_ui$Internal$Style$classes.de, $mdgriffith$elm_ui$Internal$Style$classes.al, $mdgriffith$elm_ui$Internal$Style$classes.w, $mdgriffith$elm_ui$Internal$Style$classes.b5])))
						]),
					_List_fromArray(
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.b8, $mdgriffith$elm_ui$Internal$Style$classes.de, $mdgriffith$elm_ui$Internal$Style$classes.al, $mdgriffith$elm_ui$Internal$Style$classes.w, $mdgriffith$elm_ui$Internal$Style$classes.b3])))
						]),
					_List_fromArray(
						[html])) : html));
			case 1:
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.b8, $mdgriffith$elm_ui$Internal$Style$classes.de, $mdgriffith$elm_ui$Internal$Style$classes.al, $mdgriffith$elm_ui$Internal$Style$classes.b4])))
						]),
					_List_fromArray(
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.b8, $mdgriffith$elm_ui$Internal$Style$classes.de, $mdgriffith$elm_ui$Internal$Style$classes.al, $mdgriffith$elm_ui$Internal$Style$classes.b2])))
						]),
					_List_fromArray(
						[html])) : html));
			default:
		...
		_List_fromArray(
			[
				...
				A2(
					...
					' ',
					_List_fromArray(
						[$mdgriffith$elm_ui$Internal$Style$classes.b8, $mdgriffith$elm_ui$Internal$Style$classes.ds, $mdgriffith$elm_ui$Internal$Style$classes.aV, $mdgriffith$elm_ui$Internal$Style$classes.aq])))
			]),
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				A2(
					...
					' ',
					_List_fromArray(
						[$mdgriffith$elm_ui$Internal$Style$classes.b8, $mdgriffith$elm_ui$Internal$Style$classes.ds, $mdgriffith$elm_ui$Internal$Style$classes.aW, $mdgriffith$elm_ui$Internal$Style$classes.aI])))
			]),
		_List_fromArray(
			[
						...
						switch (location) {
							case 0:
								return A2(
									...
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.Q, $mdgriffith$elm_ui$Internal$Style$classes.de, $mdgriffith$elm_ui$Internal$Style$classes.bZ]));
							case 1:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.Q, $mdgriffith$elm_ui$Internal$Style$classes.de, $mdgriffith$elm_ui$Internal$Style$classes.cd]));
							case 2:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.Q, $mdgriffith$elm_ui$Internal$Style$classes.de, $mdgriffith$elm_ui$Internal$Style$classes.cX]));
							case 3:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.Q, $mdgriffith$elm_ui$Internal$Style$classes.de, $mdgriffith$elm_ui$Internal$Style$classes.cV]));
							case 4:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.Q, $mdgriffith$elm_ui$Internal$Style$classes.de, $mdgriffith$elm_ui$Internal$Style$classes.cK]));
							default:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.Q, $mdgriffith$elm_ui$Internal$Style$classes.de, $mdgriffith$elm_ui$Internal$Style$classes.cc]));
						}
					}())
				]),
			_List_fromArray(
...
var $mdgriffith$elm_ui$Internal$Model$alignXName = function (align) {
	switch (align) {
		...
		default:
			return $mdgriffith$elm_ui$Internal$Style$classes.aB + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.b0);
	}
};
var $mdgriffith$elm_ui$Internal$Model$alignYName = function (align) {
	switch (align) {
		...
		case 2:
			return $mdgriffith$elm_ui$Internal$Style$classes.aC + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.b$);
		default:
			return $mdgriffith$elm_ui$Internal$Style$classes.aC + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.b1);
	}
};
			...
			return (portion === 1) ? _Utils_Tuple3(
				...
				_List_fromArray(
					[
						...
						$mdgriffith$elm_ui$Internal$Style$classes.b8 + ('.' + ($mdgriffith$elm_ui$Internal$Style$classes.bI + (' > ' + $mdgriffith$elm_ui$Internal$Style$dot(
								...
								case 2:
									...
									if (portion === 1) {
										...
										var $temp$classes = classes + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.bf + (' height-fill-' + $elm$core$String$fromInt(portion)))),
											...
											A3(
												$mdgriffith$elm_ui$Internal$Model$Single,
												$mdgriffith$elm_ui$Internal$Style$classes.b8 + ('.' + ($mdgriffith$elm_ui$Internal$Style$classes.v + (' > ' + $mdgriffith$elm_ui$Internal$Style$dot(
													'height-fill-' + $elm$core$String$fromInt(portion))))),
												'flex-grow',
												$elm$core$String$fromInt(portion * 100000)),
											styles),
...
var $author$project$Data$Atom$errorAtom = $author$project$Data$Atom$Atom('Error')('Err')(2)(3)(1)(1)(1)('69.6969')(
	_List_fromArray(
		[6, 9]))('https://en.wikipedia.org/wiki/PewDiePie_vs_T-Series')('ree')('Joshua Ji')('Penis Parker')(
	{
		a1: $elm$core$Maybe$Just(4000),
		bq: $elm$core$Maybe$Just(2000)
	});
...
var $mdgriffith$elm_ui$Element$Font$light = A2($mdgriffith$elm_ui$Internal$Model$Class, $mdgriffith$elm_ui$Internal$Flag$fontWeight, $mdgriffith$elm_ui$Internal$Style$classes.dz);
					...
					A2(
						...
						A2(
							...
							A2(
								...
								A2(
									$elm$core$List$cons,
									$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.an + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.w)),
									attrs)))))),
			$mdgriffith$elm_ui$Internal$Model$Unkeyed(
				_List_fromArray(
					[label])));
...
var $mdgriffith$elm_ui$Element$row = F2(
	function (attrs, children) {
		return A4(
			...
			A2(
				$elm$core$List$cons,
				$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.Y + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.w)),
				A2(
					$elm$core$List$cons,
					$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$shrink),
					A2(
...
var $author$project$Main$atomZoomContent = function (model) {
	...
	var atomBoxZoom = function () {
		var atomWeight = A2(
			...
			$mdgriffith$elm_ui$Element$text(atom.dO));
		var atomSymbol = A2(
			$mdgriffith$elm_ui$Element$el,
			_List_fromArray(
				[
					...
					$author$project$Colours$stateColour(atom.dk))
				]),
			$mdgriffith$elm_ui$Element$text(atom.dr));
		var atomShells = A2(
		...
		var atomNum = A2(
			...
			$mdgriffith$elm_ui$Element$text(
				$elm$core$String$fromInt(atom.c4)));
		var atomName = A2(
			$mdgriffith$elm_ui$Element$el,
			_List_fromArray(
				[
			...
			$mdgriffith$elm_ui$Element$text(atom.bs));
		return A2(
			$mdgriffith$elm_ui$Element$column,
			_List_fromArray(
				[
			...
			[
				...
				_List_fromArray(
					[
						...
						$mdgriffith$elm_ui$Element$text(atom.cx))
					])),
				A2(
				$mdgriffith$elm_ui$Element$paragraph,
				_List_Nil,
				_List_fromArray(
					[
						...
						_List_fromArray(
							[$mdgriffith$elm_ui$Element$Font$light]),
						$mdgriffith$elm_ui$Element$text(atom.cT))
					])),
				A2(
				$mdgriffith$elm_ui$Element$column,
				_List_fromArray(
								...
								$mdgriffith$elm_ui$Element$text(
									A2(
										...
										A2(
											...
											A2($elm$core$Maybe$map, $elm$core$String$fromFloat, atom.c2.bq)))))
							])),
						A2(
						$mdgriffith$elm_ui$Element$paragraph,
						_List_Nil,
								...
								$mdgriffith$elm_ui$Element$text(
									A2(
										...
										A2(
											...
											A2($elm$core$Maybe$map, $elm$core$String$fromFloat, atom.c2.a1)))))
							]))
					])),
				A2(
				$mdgriffith$elm_ui$Element$paragraph,
				...
				_List_fromArray(
					[
						$mdgriffith$elm_ui$Element$text(atom.dq)
					])),
				A2(
				...
				{
					bo: $mdgriffith$elm_ui$Element$text('Read More'),
					dM: atom.dP
				})
			]));
	return A2(
...
var $mdgriffith$elm_ui$Internal$Model$optionsToRecord = function (options) {
	...
	return andFinally(
		A3(
			$elm$core$List$foldr,
			combine,
			{cC: $elm$core$Maybe$Nothing, cG: $elm$core$Maybe$Nothing, cS: $elm$core$Maybe$Nothing},
			options));
};
			...
			A2(
				...
				$mdgriffith$elm_ui$Internal$Model$htmlClass(
					A2(
						...
						' ',
						_List_fromArray(
							[$mdgriffith$elm_ui$Internal$Style$classes.c7, $mdgriffith$elm_ui$Internal$Style$classes.b8, $mdgriffith$elm_ui$Internal$Style$classes.de]))),
...
var $author$project$GithubLogo$view = function (options) {
	return $mdgriffith$elm_ui$Element$html(
		A2(
			...
			_List_fromArray(
				[
					$elm$html$Html$Attributes$href(options.bi),
				...
				[
					...
					_List_fromArray(
						[
							...
							$elm$svg$Svg$Attributes$color(options.ah)
						]),
					_List_fromArray(
						[
							A2(
							...
							_List_fromArray(
								[
									...
									$elm$svg$Svg$Attributes$fill(options.ah),
		...
		$mdgriffith$elm_ui$Element$layoutWith,
		{
			c$: _List_fromArray(
				[
					...
					{ca: $elm$core$Maybe$Nothing, cg: $elm$core$Maybe$Nothing, dd: $elm$core$Maybe$Nothing})
				])
		},
		_List_fromArray(
			[
				...
				A2(
					...
					$author$project$GithubLogo$view(
						{a$: '#fff', ah: '#33333d', bi: 'https://github.com/joshuanianji/Compsci-IA'})))
			]),
		pageElements);
};
		...
		case 0:
			...
			if (!maybeAtom.$) {
				...
				return A2(
					...
					$elm$core$String$toFloat(atom.dO));
			} else {
				return $elm$core$Maybe$Nothing;
			}
		case 1:
...
var $author$project$DataBase$DataParser$placeholders = _List_fromArray(
	[
		...
		{bs: 'Lanthanide', bK: 9, bX: 3}),
		$author$project$Data$Atom$PTablePlaceholder(
		{bs: 'Actinide', bK: 10, bX: 3})
	]);
...
var $author$project$Main$pTableBox = F2(
	function (model, pTableAtom) {
		var borderWidths = {aF: 2, aJ: 0, aP: 0, aT: 0};
		if (!pTableAtom.$) {
			var atom = pTableAtom.a;
			var attributes = A2(
				$elm$core$List$cons,
				A2($elm$core$List$member, atom, model.y.aw) ? $mdgriffith$elm_ui$Element$Background$color(
					$author$project$Colours$sectionColour(atom.bK)) : $mdgriffith$elm_ui$Element$Background$color($author$project$Colours$atomBoxBackground),
				_List_fromArray(
					[
						$mdgriffith$elm_ui$Element$width(
						...
						$author$project$Colours$sectionColour(atom.bK)),
						$mdgriffith$elm_ui$Element$pointer,
			...
			return A2(
				...
				_List_fromArray(
					[
						...
						$mdgriffith$elm_ui$Element$Border$widthEach(borderWidths),
						$mdgriffith$elm_ui$Element$Border$color(
						$author$project$Colours$sectionColour(placeholder.bK))
					]),
				A2(
					$mdgriffith$elm_ui$Element$el,
					_List_fromArray(
		...
		function (pTableAtomList, atomGroup) {
			return A2(
				...
				function (pTableAtom) {
					if (!pTableAtom.$) {
						var atom = pTableAtom.a;
						return _Utils_eq(atom.bX, atomGroup);
					} else {
						var placeholder = pTableAtom.a;
						return _Utils_eq(placeholder.bX, atomGroup);
					}
				},
				pTableAtomList);
		});
		...
		var _v0 = function () {
			...
			if (!_v1.$) {
				...
				var _v3 = A3(
					...
					{j: _List_Nil, aq: $elm$core$Maybe$Nothing, as: $elm$core$Maybe$Nothing, at: $elm$core$Maybe$Nothing, au: $elm$core$Maybe$Nothing},
					attributes);
				var maybePadding = _v3.at;
				var heightContent = _v3.aq;
				var maybeSpacing = _v3.au;
				var adjustedAttributes = _v3.j;
				var maybeBorder = _v3.as;
							...
							[
								...
								if (maybePadding.$ === 1) {
									...
									return $mdgriffith$elm_ui$Element$paddingEach(
										{
											aF: A2($elm$core$Basics$max, 0, b - ((spacing / 2) | 0)),
											aJ: l,
											aP: r,
											aT: A2($elm$core$Basics$max, 0, t - ((spacing / 2) | 0))
										});
								}
							}(),
								function () {
								if (heightContent.$ === 1) {
									...
									if (heightContent.a) {
										return A4($mdgriffith$elm_ui$Element$Input$textHeightContent, textOptions.ds, spacing, maybePadding, maybeBorder);
									} else {
										return $mdgriffith$elm_ui$Internal$Model$NoAttribute;
									}
								}
													...
													_Utils_ap(
														_List_fromArray(
															[
																...
																$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.bt + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.c1)),
																$mdgriffith$elm_ui$Element$Border$color(
																A4($mdgriffith$elm_ui$Element$rgba, 0, 0, 0, 0)),
																$mdgriffith$elm_ui$Element$Background$color(
																A4($mdgriffith$elm_ui$Element$rgba, 0, 0, 0, 0)),
...
var $author$project$Main$tableAndParserView = function (model) {
	...
	var displayedMolarMass = A2(
		...
		$mdgriffith$elm_ui$Element$text(
			molarMassString(model.y._) + ' g/mol'));
	var displayedCompound = A2(
		...
		$author$project$Data$Molecule$viewMaybe(model.y._));
	var compoundInput = A2(
			...
			]),
		{
			...
			cU: $author$project$Main$UpdateMoleculeParser,
...
var $author$project$Main$main = $elm$browser$Browser$element(
	{cL: $author$project$Main$init, dp: $author$project$Main$subscriptions, dL: $author$project$Main$update, dN: $author$project$Main$view});
